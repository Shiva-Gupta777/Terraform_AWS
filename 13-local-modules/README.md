...
[DONE] Create a VPC with a given CIDR block
Allow the user to provide the configuration for multiple subnets:
 ...
 2.3.1 If at least one subnet is public, we need to deploy an IGW  (INTERNET GATEWAY)
 2.3.2 We need to associate the public subnets with a public RTB  (ROUTE TABLE)